  ...
  <div class="side-bar">
    <div class="side-bar-section">
      <div class="side-bar-section-logo">
        <RxelmsLogo class="side-bar-section-logo-icon" />
        <IconsDartroomLogoName
          v-show="wide"
          class="side-bar-section-logo-name" />

        <div
          class="side-bar-section-logo-tag"
          :class="
            env.RELEASE === 'Alpha'
              ? 'side-bar-section-logo-tag-alpha'
              : 'side-bar-section-logo-tag-beta'
          "
          v-show="wide">
          <span
            >{{ env.RELEASE }}-{{
              settignsStore.appSettings.network.toLowerCase()
            }}</span
          >
      ...
      <Tooltip
        ...
        <Notification :inline="wide">
          <NavBarButton
            ...
            to="/listings/buy-now"
            :active="
              $router.currentRoute.value.fullPath === '/listings/buy-now'
            ">
            <IconsPriceTag />
    ...
    <div class="side-bar-section">
      <Tooltip
        text="Create"
        :on="!wide"
        v-show="accountStore.userInfo?.user.isArtist">
        <Notification :inline="wide">
          <NavBarButton
            to="/create"
            name="Create"
      ...
      <Tooltip
        ...
        <Notification
          :inline="wide"
          v-show="accountStore.activeWallet">
          <NavBarButton
            :to="
              accountStore.userInfo?.user.isArtist
                ? '/manage/created'
                : '/manage'
            "
            name="Manage"
            :active="$router.currentRoute.value.fullPath.includes('/manage')">
            <IconsFolder />
      ...
      <Tooltip
        ...
        <Notification :inline="wide">
          <NavBarButton
            to="/settings"
            name="Settings"
            :active="$router.currentRoute.value.fullPath.includes('/settings')">
            <IconsSettings />
      ...
      <Tooltip
        ...
        :on="!wide"
        v-show="accountStore.userInfo?.user.isAdmin">
        <Notification :inline="wide">
          <NavBarButton
            name="Admin dashboard"
            to="/admin"
            :active="$router.currentRoute.value.fullPath.includes('/admin')">
            <IconsAdmin />
          ...
          <NavBarButton
            ...
            :active="
              $router.currentRoute.value.fullPath.includes(
                `/artists/${accountStore.userInfo?.user.artist?.normalizedName}`
              )
            ">
            <IconsAccountBox />
