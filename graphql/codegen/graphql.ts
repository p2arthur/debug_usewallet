...
export type Scalars = {
  ...
  Int: number;
  Float: number;
  /** Algorand wallet address. An Algorand address is based on the public key of the user's wallet and is a 58 characters long `String` with only capital letters and numbers. (example: 'VCMJKWOY5P5P7SKMZFFOCEROPJCZOTIJMNIYNUCKH7LRO45JMJP6UYBIJA') */
  AlgorandAddress: any;
  /** A `string` representing a standard email address according to the RFC5322 specification. */
  EmailAddress: any;
  JSONObject: any;
  /** 12-byte long `string` representing the ID of the document. */
  ObjectId: any;
  /** Timestamp in the form of a ISO 8601 string. */
  Timestamp: any;
...
export type ChangeApplicationStatusMutation = { __typename?: 'Mutation', changeApplicationStatus: { __typename?: 'ApplicationDetails', id: any, name: string, email: any, status: ApplicationStatuses, twitter?: string | null, instagram?: string | null, links?: string | null, art?: Array<string> | null, inviteLink?: string | null, accountCreated: boolean } };
...
export type InviteArtistMutation = { __typename?: 'Mutation', inviteArtist: { __typename?: 'ApplicationDetails', id: any, name: string, email: any, status: ApplicationStatuses, twitter?: string | null, instagram?: string | null, links?: string | null, art?: Array<string> | null, inviteLink?: string | null, accountCreated: boolean } };
...
export type UpsertCollectionMutation = { __typename?: 'Mutation', upsertCollection: { __typename?: 'CollectionSettings', id?: any | null, title: string, normalizedTitle: string, description: string, private: boolean, locked: boolean, rarity: boolean, type: string, mintingAddresses: Array<{ __typename?: 'CollectionAddress', address: string, active: boolean, locked: boolean }>, attributes: Array<{ __typename?: 'CollectionSettingsAttribute', traitType: string, displayType: string, values: Array<{ __typename?: 'CollectionSettingsAttributeValue', value: string, locked: boolean, rarityScore?: number | null }>, range: { __typename?: 'CollectionSettingsAttributeRange', max: number, min: number, usedValues: Array<number> } }>, media: { __typename?: 'CollectionMedia', card?: { __typename?: 'Media', cid: string, mimeType: string, previews: Array<{ __typename?: 'MediaPreview', size: number, cid: string, mimeType: string }> } | null, banner?: { __typename?: 'Media', cid: string, mimeType: string, previews: Array<{ __typename?: 'MediaPreview', size: number, cid: string, mimeType: string }> } | null }, artists: Array<{ __typename?: 'CollectionSettingsArtist', id: string, address: any, name: string, normalizedName: string, status: string, profileImage?: { __typename?: 'Media', cid: string, mimeType: string, previews: Array<{ __typename?: 'MediaPreview', size: number, cid: string, mimeType: string }> } | null }>, stats: { __typename?: 'CollectionStats', nNFTs: number, sales: number, floor: any, volume: any } } };
...
export type DeleteNfTsMutation = { __typename?: 'Mutation', deleteNFTs: Array<any> };
...
export type EditNftMutation = { __typename?: 'Mutation', editNFT: { __typename?: 'NFTSettings', id?: any | null, status: Nft_State, stage: Edit_Stage, edit: { __typename?: 'NFTSettingsEdit', info: Nft_Edit_State, collection: Nft_Edit_State, media: Nft_Edit_State, token: Nft_Edit_State }, info: { __typename?: 'NFTSettingsInfo', title: string, description: string, link: string, nsfw: boolean, ai: boolean, aiDescription: string, tags: Array<string> }, token: { __typename?: 'NFTSettingsToken', unitName: string, assetName: string, royalty: number, editions: number }, artist: { __typename?: 'NFTSettingsArtist', id: string, name: string, normalizedName: string, address: string, profileImage?: { __typename?: 'Media', cid: string, mimeType: string, previews: Array<{ __typename?: 'MediaPreview', size: number, cid: string, mimeType: string }> } | null }, c?: { __typename?: 'NFTSettingsCollection', id: string, title: string, attributes: Array<{ __typename?: 'NFTSettingsCollectionAttribute', traitType: string, value: string, displayType: string }> } | null, card: { __typename?: 'NFTSettingsCard', x: number, y: number, type: Card_Type }, media?: { __typename?: 'NFTSettingsMedia', fileroomId: string, cid: string, dimensions: string, storageSize: number, mimeType: string, integrity: string, previews: Array<{ __typename?: 'NFTSettingsMediaPreview', size: number, cid: string, mimeType: string, integrity?: string | null }>, thumbnail?: { __typename?: 'Media', cid: string, mimeType: string, previews: Array<{ __typename?: 'MediaPreview', size: number, cid: string, mimeType: string }> } | null } | null } };
...
export type SubmitMintNftMutation = { __typename?: 'Mutation', submitMintNFT: { __typename?: 'MintingInfo', partialErrors?: Array<string> | null, nfts: Array<{ __typename?: 'NFTSettings', id?: any | null, status: Nft_State, stage: Edit_Stage, edit: { __typename?: 'NFTSettingsEdit', info: Nft_Edit_State, collection: Nft_Edit_State, media: Nft_Edit_State, token: Nft_Edit_State }, info: { __typename?: 'NFTSettingsInfo', title: string, description: string, link: string, nsfw: boolean, ai: boolean, aiDescription: string, tags: Array<string> }, token: { __typename?: 'NFTSettingsToken', unitName: string, assetName: string, royalty: number, editions: number }, artist: { __typename?: 'NFTSettingsArtist', id: string, name: string, normalizedName: string, address: string, profileImage?: { __typename?: 'Media', cid: string, mimeType: string, previews: Array<{ __typename?: 'MediaPreview', size: number, cid: string, mimeType: string }> } | null }, c?: { __typename?: 'NFTSettingsCollection', id: string, title: string, attributes: Array<{ __typename?: 'NFTSettingsCollectionAttribute', traitType: string, value: string, displayType: string }> } | null, card: { __typename?: 'NFTSettingsCard', x: number, y: number, type: Card_Type }, media?: { __typename?: 'NFTSettingsMedia', fileroomId: string, cid: string, dimensions: string, storageSize: number, mimeType: string, integrity: string, previews: Array<{ __typename?: 'NFTSettingsMediaPreview', size: number, cid: string, mimeType: string, integrity?: string | null }>, thumbnail?: { __typename?: 'Media', cid: string, mimeType: string, previews: Array<{ __typename?: 'MediaPreview', size: number, cid: string, mimeType: string }> } | null } | null }> } };
...
export type SubmitBuyFixedBidMutation = { __typename?: 'Mutation', submitBuyFixedBid: { __typename?: 'FixedBidInfo', partialErrors?: Array<string> | null, listings: Array<{ __typename?: 'FixedBidListing', nftIndex: number, appId: number, currency: AsaCode, sellerAddress: any, sellerPayoutAddress: any, royaltyPayoutAddress: any, managerPayoutAddress: any, sellerRevenueSink?: any | null, royaltyRevenueSink?: any | null, contractAddress: any, sellerShare: number, royaltyShare: number, managerShare: number, price: number, primary: boolean, status: { __typename?: 'FixedBidStatus', deleted: boolean, isSetup: boolean, balance: number } }> } };
...
export type SubmitDeployFixedBidMutation = { __typename?: 'Mutation', submitDeployFixedBid: { __typename?: 'FixedBidInfo', partialErrors?: Array<string> | null, listings: Array<{ __typename?: 'FixedBidListing', nftIndex: number, appId: number, currency: AsaCode, sellerAddress: any, sellerPayoutAddress: any, royaltyPayoutAddress: any, managerPayoutAddress: any, sellerRevenueSink?: any | null, royaltyRevenueSink?: any | null, contractAddress: any, sellerShare: number, royaltyShare: number, managerShare: number, price: number, primary: boolean, status: { __typename?: 'FixedBidStatus', deleted: boolean, isSetup: boolean, balance: number } }> } };
...
export type SubmitDepositFixedBidMutation = { __typename?: 'Mutation', submitDepositFixedBid: { __typename?: 'FixedBidInfo', partialErrors?: Array<string> | null, listings: Array<{ __typename?: 'FixedBidListing', nftIndex: number, appId: number, currency: AsaCode, sellerAddress: any, sellerPayoutAddress: any, royaltyPayoutAddress: any, managerPayoutAddress: any, sellerRevenueSink?: any | null, royaltyRevenueSink?: any | null, contractAddress: any, sellerShare: number, royaltyShare: number, managerShare: number, price: number, primary: boolean, status: { __typename?: 'FixedBidStatus', deleted: boolean, isSetup: boolean, balance: number } }> } };
...
export type SubmitExtractFixedBidMutation = { __typename?: 'Mutation', submitExtractFixedBid: { __typename?: 'FixedBidInfo', partialErrors?: Array<string> | null, listings: Array<{ __typename?: 'FixedBidListing', nftIndex: number, appId: number, currency: AsaCode, sellerAddress: any, sellerPayoutAddress: any, royaltyPayoutAddress: any, managerPayoutAddress: any, sellerRevenueSink?: any | null, royaltyRevenueSink?: any | null, contractAddress: any, sellerShare: number, royaltyShare: number, managerShare: number, price: number, primary: boolean, status: { __typename?: 'FixedBidStatus', deleted: boolean, isSetup: boolean, balance: number } }> } };
...
export type SubmitSetupFixedBidMutation = { __typename?: 'Mutation', submitSetupFixedBid: { __typename?: 'FixedBidInfo', partialErrors?: Array<string> | null, listings: Array<{ __typename?: 'FixedBidListing', nftIndex: number, appId: number, currency: AsaCode, sellerAddress: any, sellerPayoutAddress: any, royaltyPayoutAddress: any, managerPayoutAddress: any, sellerRevenueSink?: any | null, royaltyRevenueSink?: any | null, contractAddress: any, sellerShare: number, royaltyShare: number, managerShare: number, price: number, primary: boolean, status: { __typename?: 'FixedBidStatus', deleted: boolean, isSetup: boolean, balance: number } }> } };
...
export type SubmitUpdatePriceFixedBidMutation = { __typename?: 'Mutation', submitUpdatePriceFixedBid: { __typename?: 'FixedBidInfo', partialErrors?: Array<string> | null, listings: Array<{ __typename?: 'FixedBidListing', nftIndex: number, appId: number, currency: AsaCode, sellerAddress: any, sellerPayoutAddress: any, royaltyPayoutAddress: any, managerPayoutAddress: any, sellerRevenueSink?: any | null, royaltyRevenueSink?: any | null, contractAddress: any, sellerShare: number, royaltyShare: number, managerShare: number, price: number, primary: boolean, status: { __typename?: 'FixedBidStatus', deleted: boolean, isSetup: boolean, balance: number } }> } };
...
export type UserLoginInfoQuery = { __typename?: 'Query', userLoginInfo: { __typename?: 'UserLoginInfo', walletAddress: any, hasPassword: boolean, newUser: boolean }, verifyTxn: Array<Array<{ __typename?: 'UsignedTxn', description: string, txID: string, blob: any, signers: Array<any>, signature: string, authAddress: any }>> };
...
export type GetApplicationsQuery = { __typename?: 'Query', getApplications: { __typename?: 'ApplicationsPaginated', applications: Array<{ __typename?: 'ApplicationDetails', id: any, name: string, email: any, status: ApplicationStatuses, twitter?: string | null, instagram?: string | null, links?: string | null, art?: Array<string> | null, inviteLink?: string | null, accountCreated: boolean }>, pageInfo: { __typename?: 'PageInfo', totalDocs: number, offset: number, limit: number, totalPages: number, page: number, hasPrevPage: boolean, hasNextPage: boolean, prevPage?: number | null, nextPage?: number | null } } };
...
export type GetBandsQuery = { __typename?: 'Query', getBands: { __typename?: 'BandsPaginated', bands: Array<{ __typename?: 'BandDetails', id: any, name: string, status: BandStatuses, period: number, wallets?: Array<string> | null, date?: { __typename?: 'BandDate', startDate: string, endDate: string } | null }>, pageInfo: { __typename?: 'PageInfo', totalDocs: number, offset: number, limit: number, totalPages: number, page: number, hasPrevPage: boolean, hasNextPage: boolean, prevPage?: number | null, nextPage?: number | null } } };
...
export type SearchArtistQuery = { __typename?: 'Query', searchArtist: Array<{ __typename?: 'UserAritstInfo', name: string, normalizedName: string, location: string, joinDate: any, page: { __typename?: 'ArtistPage', description: string, profileImage?: { __typename?: 'Media', cid: string, mimeType: string, previews: Array<{ __typename?: 'MediaPreview', size: number, cid: string, mimeType: string }> } | null, bannerImage?: { __typename?: 'Media', cid: string, mimeType: string, previews: Array<{ __typename?: 'MediaPreview', size: number, cid: string, mimeType: string }> } | null, customLinks: Array<{ __typename?: 'CustomLink', name: string, url: string }> }, stats: { __typename?: 'ArtistStats', totalMinted: number, totalSold: any, floor: any }, featured: { __typename?: 'UserArtistFeatured', isFeatured: boolean, categories: Array<string> } }> };
...
export type GetAllCollectionsQuery = { __typename?: 'Query', getAllCollections: { __typename?: 'CollectionsPaginated', collections: Array<{ __typename?: 'Collection', id: any, title: string, normalizedTitle: string, description: string, rarity: boolean, attributes: Array<{ __typename?: 'CollectionAttribute', traitType: string, displayType: string, values: Array<{ __typename?: 'CollectionAttributeValue', value: string, rarityScore?: number | null }>, range: { __typename?: 'CollectionAttributeRange', max: number, min: number } }>, media: { __typename?: 'CollectionMedia', card?: { __typename?: 'Media', cid: string, mimeType: string, previews: Array<{ __typename?: 'MediaPreview', size: number, cid: string, mimeType: string }> } | null, banner?: { __typename?: 'Media', cid: string, mimeType: string, previews: Array<{ __typename?: 'MediaPreview', size: number, cid: string, mimeType: string }> } | null }, artists: Array<{ __typename?: 'CollectionArtist', id: string, address: any, name: string, normalizedName: string, profileImage?: { __typename?: 'Media', cid: string, mimeType: string, previews: Array<{ __typename?: 'MediaPreview', size: number, cid: string, mimeType: string }> } | null }>, stats: { __typename?: 'CollectionStats', nNFTs: number, sales: number, floor: any, volume: any } }>, pageInfo: { __typename?: 'PageInfo', totalDocs: number, offset: number, limit: number, totalPages: number, page: number, hasPrevPage: boolean, hasNextPage: boolean, prevPage?: number | null, nextPage?: number | null } } };
...
export type GetCollectionDetailsQuery = { __typename?: 'Query', getCollectionDetails: { __typename?: 'Collection', id: any, title: string, normalizedTitle: string, description: string, rarity: boolean, attributes: Array<{ __typename?: 'CollectionAttribute', traitType: string, displayType: string, values: Array<{ __typename?: 'CollectionAttributeValue', value: string, rarityScore?: number | null }>, range: { __typename?: 'CollectionAttributeRange', max: number, min: number } }>, media: { __typename?: 'CollectionMedia', card?: { __typename?: 'Media', cid: string, mimeType: string, previews: Array<{ __typename?: 'MediaPreview', size: number, cid: string, mimeType: string }> } | null, banner?: { __typename?: 'Media', cid: string, mimeType: string, previews: Array<{ __typename?: 'MediaPreview', size: number, cid: string, mimeType: string }> } | null }, artists: Array<{ __typename?: 'CollectionArtist', id: string, address: any, name: string, normalizedName: string, profileImage?: { __typename?: 'Media', cid: string, mimeType: string, previews: Array<{ __typename?: 'MediaPreview', size: number, cid: string, mimeType: string }> } | null }>, stats: { __typename?: 'CollectionStats', nNFTs: number, sales: number, floor: any, volume: any } } };
...
export type SearchCollectionQuery = { __typename?: 'Query', searchCollection: Array<{ __typename?: 'Collection', id: any, title: string, normalizedTitle: string, description: string, rarity: boolean, attributes: Array<{ __typename?: 'CollectionAttribute', traitType: string, displayType: string, values: Array<{ __typename?: 'CollectionAttributeValue', value: string, rarityScore?: number | null }>, range: { __typename?: 'CollectionAttributeRange', max: number, min: number } }>, media: { __typename?: 'CollectionMedia', card?: { __typename?: 'Media', cid: string, mimeType: string, previews: Array<{ __typename?: 'MediaPreview', size: number, cid: string, mimeType: string }> } | null, banner?: { __typename?: 'Media', cid: string, mimeType: string, previews: Array<{ __typename?: 'MediaPreview', size: number, cid: string, mimeType: string }> } | null }, artists: Array<{ __typename?: 'CollectionArtist', id: string, address: any, name: string, normalizedName: string, profileImage?: { __typename?: 'Media', cid: string, mimeType: string, previews: Array<{ __typename?: 'MediaPreview', size: number, cid: string, mimeType: string }> } | null }>, stats: { __typename?: 'CollectionStats', nNFTs: number, sales: number, floor: any, volume: any } }> };
...
export type GetCollectionSettingsQuery = { __typename?: 'Query', getCollectionSettings: { __typename?: 'CollectionSettings', id?: any | null, title: string, normalizedTitle: string, description: string, private: boolean, locked: boolean, rarity: boolean, type: string, mintingAddresses: Array<{ __typename?: 'CollectionAddress', address: string, active: boolean, locked: boolean }>, attributes: Array<{ __typename?: 'CollectionSettingsAttribute', traitType: string, displayType: string, values: Array<{ __typename?: 'CollectionSettingsAttributeValue', value: string, locked: boolean, rarityScore?: number | null }>, range: { __typename?: 'CollectionSettingsAttributeRange', max: number, min: number, usedValues: Array<number> } }>, media: { __typename?: 'CollectionMedia', card?: { __typename?: 'Media', fileroomId?: string | null, cid: string, mimeType: string, previews: Array<{ __typename?: 'MediaPreview', size: number, cid: string, mimeType: string }> } | null, banner?: { __typename?: 'Media', fileroomId?: string | null, cid: string, mimeType: string, previews: Array<{ __typename?: 'MediaPreview', size: number, cid: string, mimeType: string }> } | null }, artists: Array<{ __typename?: 'CollectionSettingsArtist', id: string, address: any, name: string, normalizedName: string, status: string, profileImage?: { __typename?: 'Media', cid: string, mimeType: string, previews: Array<{ __typename?: 'MediaPreview', size: number, cid: string, mimeType: string }> } | null }>, stats: { __typename?: 'CollectionStats', nNFTs: number, sales: number, floor: any, volume: any } } };

export type GetUserCollectionsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetUserCollectionsQuery = { __typename?: 'Query', getUserCollections: Array<{ __typename?: 'CollectionSettings', id?: any | null, title: string, normalizedTitle: string, description: string, private: boolean, locked: boolean, rarity: boolean, type: string, mintingAddresses: Array<{ __typename?: 'CollectionAddress', address: string, active: boolean, locked: boolean }>, attributes: Array<{ __typename?: 'CollectionSettingsAttribute', traitType: string, displayType: string, values: Array<{ __typename?: 'CollectionSettingsAttributeValue', value: string, locked: boolean, rarityScore?: number | null }>, range: { __typename?: 'CollectionSettingsAttributeRange', max: number, min: number, usedValues: Array<number> } }>, media: { __typename?: 'CollectionMedia', card?: { __typename?: 'Media', cid: string, mimeType: string, previews: Array<{ __typename?: 'MediaPreview', size: number, cid: string, mimeType: string }> } | null, banner?: { __typename?: 'Media', cid: string, mimeType: string, previews: Array<{ __typename?: 'MediaPreview', size: number, cid: string, mimeType: string }> } | null }, artists: Array<{ __typename?: 'CollectionSettingsArtist', id: string, address: any, name: string, normalizedName: string, status: string, profileImage?: { __typename?: 'Media', cid: string, mimeType: string, previews: Array<{ __typename?: 'MediaPreview', size: number, cid: string, mimeType: string }> } | null }>, stats: { __typename?: 'CollectionStats', nNFTs: number, sales: number, floor: any, volume: any } }> };
...
export type GetDeleteNftParamsQuery = { __typename?: 'Query', getDeleteNFTParams: Array<Array<{ __typename?: 'UsignedTxn', description: string, blob: any, txID: string, signers: Array<any>, signature: string, authAddress: any }>> };
...
export type GetMintNftParamsQuery = { __typename?: 'Query', getMintNFTParams: Array<Array<{ __typename?: 'UsignedTxn', description: string, txID: string, signers: Array<any>, signature: string, authAddress: any, blob: any }>> };
...
export type GetNftSettingsQuery = { __typename?: 'Query', getNFTSettings: { __typename?: 'NFTSettings', id?: any | null, status: Nft_State, stage: Edit_Stage, edit: { __typename?: 'NFTSettingsEdit', info: Nft_Edit_State, collection: Nft_Edit_State, media: Nft_Edit_State, token: Nft_Edit_State }, info: { __typename?: 'NFTSettingsInfo', title: string, description: string, link: string, nsfw: boolean, ai: boolean, aiDescription: string, tags: Array<string> }, token: { __typename?: 'NFTSettingsToken', unitName: string, assetName: string, royalty: number, editions: number }, artist: { __typename?: 'NFTSettingsArtist', id: string, name: string, normalizedName: string, address: string, profileImage?: { __typename?: 'Media', cid: string, mimeType: string, previews: Array<{ __typename?: 'MediaPreview', size: number, cid: string, mimeType: string }> } | null }, c?: { __typename?: 'NFTSettingsCollection', id: string, title: string, attributes: Array<{ __typename?: 'NFTSettingsCollectionAttribute', traitType: string, value: string, displayType: string }> } | null, card: { __typename?: 'NFTSettingsCard', x: number, y: number, type: Card_Type }, media?: { __typename?: 'NFTSettingsMedia', fileroomId: string, cid: string, dimensions: string, storageSize: number, mimeType: string, integrity: string, previews: Array<{ __typename?: 'NFTSettingsMediaPreview', size: number, cid: string, mimeType: string, integrity?: string | null }>, thumbnail?: { __typename?: 'Media', cid: string, mimeType: string, previews: Array<{ __typename?: 'MediaPreview', size: number, cid: string, mimeType: string }> } | null } | null } };

export type GetNftTemplateQueryVariables = Exact<{ [key: string]: never; }>;


export type GetNftTemplateQuery = { __typename?: 'Query', getNFTTemplate: { __typename?: 'NFTSettings', id?: any | null, status: Nft_State, stage: Edit_Stage, edit: { __typename?: 'NFTSettingsEdit', info: Nft_Edit_State, collection: Nft_Edit_State, media: Nft_Edit_State, token: Nft_Edit_State }, info: { __typename?: 'NFTSettingsInfo', title: string, description: string, link: string, nsfw: boolean, ai: boolean, aiDescription: string, tags: Array<string> }, token: { __typename?: 'NFTSettingsToken', unitName: string, assetName: string, royalty: number, editions: number }, artist: { __typename?: 'NFTSettingsArtist', id: string, name: string, normalizedName: string, address: string, profileImage?: { __typename?: 'Media', cid: string, mimeType: string, previews: Array<{ __typename?: 'MediaPreview', size: number, cid: string, mimeType: string }> } | null }, c?: { __typename?: 'NFTSettingsCollection', id: string, title: string, attributes: Array<{ __typename?: 'NFTSettingsCollectionAttribute', traitType: string, value: string, displayType: string }> } | null, card: { __typename?: 'NFTSettingsCard', x: number, y: number, type: Card_Type }, media?: { __typename?: 'NFTSettingsMedia', fileroomId: string, cid: string, dimensions: string, storageSize: number, mimeType: string, integrity: string, previews: Array<{ __typename?: 'NFTSettingsMediaPreview', size: number, cid: string, mimeType: string, integrity?: string | null }>, thumbnail?: { __typename?: 'Media', cid: string, mimeType: string, previews: Array<{ __typename?: 'MediaPreview', size: number, cid: string, mimeType: string }> } | null } | null } };
...
export type GetBuyFixedBidParamsQuery = { __typename?: 'Query', getBuyFixedBidParams: Array<Array<{ __typename?: 'UsignedTxn', description: string, blob: any, txID: string, signers: Array<any>, signature: string, authAddress: any }>> };
...
export type GetDeployFixedBidParamsQuery = { __typename?: 'Query', getDeployFixedBidParams: Array<Array<{ __typename?: 'UsignedTxn', description: string, blob: any, txID: string, signers: Array<any>, signature: string, authAddress: any }>> };
...
export type GetDepositFixedBidParamsQuery = { __typename?: 'Query', getDepositFixedBidParams: Array<Array<{ __typename?: 'UsignedTxn', description: string, blob: any, txID: string, signers: Array<any>, signature: string, authAddress: any }>> };
...
export type GetDestroyFixedBidParamsQuery = { __typename?: 'Query', getDestroyFixedBidParams: Array<Array<{ __typename?: 'UsignedTxn', description: string, blob: any, txID: string, signers: Array<any>, signature: string, authAddress: any }>> };
...
export type GetExtractFixedBidParamsQuery = { __typename?: 'Query', getExtractFixedBidParams: Array<Array<{ __typename?: 'UsignedTxn', description: string, blob: any, txID: string, signers: Array<any>, signature: string, authAddress: any }>> };
...
export type GetFixedBidsByArtistQuery = { __typename?: 'Query', getFixedBidsByArtist: { __typename?: 'FixedBidPaginated', listings: Array<{ __typename?: 'FixedBidListing', nftIndex: number, appId: number, currency: AsaCode, sellerAddress: any, sellerPayoutAddress: any, royaltyPayoutAddress: any, managerPayoutAddress: any, sellerRevenueSink?: any | null, royaltyRevenueSink?: any | null, contractAddress: any, sellerShare: number, royaltyShare: number, managerShare: number, price: number, primary: boolean, status: { __typename?: 'FixedBidStatus', deleted: boolean, isSetup: boolean, balance: number }, nft?: { __typename?: 'NFT', id: any, info: { __typename?: 'NFTInfo', title: string }, token: { __typename?: 'NFTToken', index: number, unitName: string, assetName: string, royalty: number, editions: number, mintAddress: string, timestamp: any }, media: { __typename?: 'NFTMedia', fileroomId?: string | null, cid: string, dimensions: string, storageSize: number, mimeType: string, integrity: string, previews: Array<{ __typename?: 'NFTMediaPreview', size: number, cid: string, mimeType: string, integrity?: string | null }>, thumbnail?: { __typename?: 'Media', cid: string, mimeType: string, previews: Array<{ __typename?: 'MediaPreview', size: number, cid: string, mimeType: string }> } | null } } | null }>, pageInfo: { __typename?: 'PageInfo', totalDocs: number, offset: number, limit: number, totalPages: number, page: number, hasPrevPage: boolean, hasNextPage: boolean, prevPage?: number | null, nextPage?: number | null } } };
...
export type GetFixedBidsByCollectorQuery = { __typename?: 'Query', getFixedBidsByCollector: { __typename?: 'FixedBidPaginated', listings: Array<{ __typename?: 'FixedBidListing', nftIndex: number, appId: number, currency: AsaCode, sellerAddress: any, sellerPayoutAddress: any, royaltyPayoutAddress: any, managerPayoutAddress: any, sellerRevenueSink?: any | null, royaltyRevenueSink?: any | null, contractAddress: any, sellerShare: number, royaltyShare: number, managerShare: number, price: number, primary: boolean, status: { __typename?: 'FixedBidStatus', deleted: boolean, isSetup: boolean, balance: number }, nft?: { __typename?: 'NFT', id: any, info: { __typename?: 'NFTInfo', title: string }, token: { __typename?: 'NFTToken', index: number, unitName: string, assetName: string, royalty: number, editions: number, mintAddress: string, timestamp: any }, media: { __typename?: 'NFTMedia', fileroomId?: string | null, cid: string, dimensions: string, storageSize: number, mimeType: string, integrity: string, previews: Array<{ __typename?: 'NFTMediaPreview', size: number, cid: string, mimeType: string, integrity?: string | null }>, thumbnail?: { __typename?: 'Media', cid: string, mimeType: string, previews: Array<{ __typename?: 'MediaPreview', size: number, cid: string, mimeType: string }> } | null } } | null }>, pageInfo: { __typename?: 'PageInfo', totalDocs: number, offset: number, limit: number, totalPages: number, page: number, hasPrevPage: boolean, hasNextPage: boolean, prevPage?: number | null, nextPage?: number | null } } };
...
export type GetFixedBidsByNftQuery = { __typename?: 'Query', getFixedBidsByNFT: Array<{ __typename?: 'FixedBidListing', nftIndex: number, appId: number, currency: AsaCode, sellerAddress: any, sellerPayoutAddress: any, royaltyPayoutAddress: any, managerPayoutAddress: any, sellerRevenueSink?: any | null, royaltyRevenueSink?: any | null, contractAddress: any, sellerShare: number, royaltyShare: number, managerShare: number, price: number, primary: boolean, status: { __typename?: 'FixedBidStatus', deleted: boolean, isSetup: boolean, balance: number } }> };
...
export type GetSetupFixedBidParamsQuery = { __typename?: 'Query', getSetupFixedBidParams: Array<Array<{ __typename?: 'UsignedTxn', description: string, blob: any, txID: string, signers: Array<any>, signature: string, authAddress: any }>> };
...
export type GetUpdatePriceFixedBidParamsQuery = { __typename?: 'Query', getUpdatePriceFixedBidParams: Array<Array<{ __typename?: 'UsignedTxn', description: string, blob: any, txID: string, signers: Array<any>, signature: string, authAddress: any }>> };
...
export type GetNfdByAddressQuery = { __typename?: 'Query', getNFDByAddress: { __typename?: 'AddressNFD', address: any, nfd?: { __typename?: 'NFD', i: { __typename?: 'NFDi', name: string, asaId: number, category: string, commission1Agent?: any | null, commission1?: number | null, mintingKickoffCreator?: any | null, mintingKickoffAmount?: number | null, highestSoldAmt?: number | null, owner: any, sellamt?: number | null, saleType?: string | null, seller?: any | null, timeCreated: number, timeChanged?: number | null, timePurchased?: number | null, ver: string, contractLocked: boolean }, u: { __typename?: 'NFDu', name?: string | null, bio?: string | null, address?: string | null, email?: string | null, url?: string | null, avatar?: string | null, banner?: string | null, twitter?: string | null, discord?: string | null, telegram?: string | null, domain?: string | null, website?: string | null, caalgo?: string | null }, v: { __typename?: 'NFDv', avatar?: string | null, avatarasaid?: number | null, banner?: string | null, bannerasaid?: number | null, caAlgo?: any | null, domain?: string | null, twitter?: string | null, discord?: string | null, telegram?: string | null } } | null } };
...
export type GetNfdListByAddressesQuery = { __typename?: 'Query', getNFDListByAddresses: Array<{ __typename?: 'AddressNFD', address: any, nfd?: { __typename?: 'NFD', i: { __typename?: 'NFDi', name: string } } | null }> };
...
export type GetListedNfTsQuery = { __typename?: 'Query', getListedNFTs: { __typename?: 'NFTsPaginated', nfts: Array<{ __typename?: 'NFT', id: any, status: string, info: { __typename?: 'NFTInfo', title: string, description: string, link: string, nsfw: boolean, ai: boolean, aiDescription: string, tags: Array<string>, updated: boolean }, token: { __typename?: 'NFTToken', index: number, unitName: string, assetName: string, royalty: number, editions: number, mintAddress: string, timestamp: any }, artist: { __typename?: 'NFTArtist', id: string, address: string, name: string, normalizedName: string, suspended: boolean, deleted: boolean, profileImage?: { __typename?: 'Media', cid: string, mimeType: string, previews: Array<{ __typename?: 'MediaPreview', size: number, cid: string, mimeType: string }> } | null }, card: { __typename?: 'NFTCard', x: number, y: number, type: Card_Type }, c?: { __typename?: 'NFTCollection', id: string, title: string, normalizedTitle: string, attributes: Array<{ __typename?: 'NFTCollectionAttribute', traitType: string, value: string, displayType: string }> } | null, media: { __typename?: 'NFTMedia', fileroomId?: string | null, cid: string, dimensions: string, storageSize: number, mimeType: string, integrity: string, previews: Array<{ __typename?: 'NFTMediaPreview', size: number, cid: string, mimeType: string, integrity?: string | null }>, thumbnail?: { __typename?: 'Media', cid: string, mimeType: string, previews: Array<{ __typename?: 'MediaPreview', size: number, cid: string, mimeType: string }> } | null }, metadata: { __typename?: 'NFTMetadata', id?: string | null, cid: string, mimeType: string, integrity: string, standard: string }, listings: { __typename?: 'NFTListings', listed: boolean, fixedBid: Array<{ __typename?: 'NFTFixedBid', primary: boolean, currency: AsaCode, price: number }>, auctions: Array<{ __typename?: 'NFTAuction', primary: boolean, currency: AsaCode, price: number, duration: number, highestBid: number, started: boolean }> }, statistics: { __typename?: 'NFTStatistics', sold: boolean, latestSale?: { __typename?: 'NFTStatisticsSale', currency?: AsaCode | null, price?: number | null, usdValue?: number | null } | null } }>, pageInfo: { __typename?: 'PageInfo', totalDocs: number, offset: number, limit: number, totalPages: number, page: number, hasPrevPage: boolean, hasNextPage: boolean, prevPage?: number | null, nextPage?: number | null } } };
...
export type GetNftOwnersQuery = { __typename?: 'Query', getNFTOwners: Array<{ __typename?: 'NFTOwner', address: any, walletBalance: number, listingBalance: number }> };
...
export type GetNfTsByArtistQuery = { __typename?: 'Query', getNFTsByArtist: { __typename?: 'NFTsPaginated', nfts: Array<{ __typename?: 'NFT', id: any, info: { __typename?: 'NFTInfo', title: string, description: string, link: string, nsfw: boolean, ai: boolean, aiDescription: string, tags: Array<string>, updated: boolean }, token: { __typename?: 'NFTToken', index: number, unitName: string, assetName: string, royalty: number, editions: number, mintAddress: string, timestamp: any }, artist: { __typename?: 'NFTArtist', id: string, address: string, name: string, normalizedName: string, suspended: boolean, deleted: boolean, profileImage?: { __typename?: 'Media', cid: string, mimeType: string, previews: Array<{ __typename?: 'MediaPreview', size: number, cid: string, mimeType: string }> } | null }, card: { __typename?: 'NFTCard', x: number, y: number, type: Card_Type }, c?: { __typename?: 'NFTCollection', id: string, title: string, normalizedTitle: string, attributes: Array<{ __typename?: 'NFTCollectionAttribute', traitType: string, value: string, displayType: string }> } | null, media: { __typename?: 'NFTMedia', fileroomId?: string | null, cid: string, dimensions: string, storageSize: number, mimeType: string, integrity: string, previews: Array<{ __typename?: 'NFTMediaPreview', size: number, cid: string, mimeType: string, integrity?: string | null }>, thumbnail?: { __typename?: 'Media', cid: string, mimeType: string, previews: Array<{ __typename?: 'MediaPreview', size: number, cid: string, mimeType: string }> } | null }, metadata: { __typename?: 'NFTMetadata', id?: string | null, cid: string, mimeType: string, integrity: string, standard: string }, listings: { __typename?: 'NFTListings', listed: boolean, fixedBid: Array<{ __typename?: 'NFTFixedBid', primary: boolean, currency: AsaCode, price: number }>, auctions: Array<{ __typename?: 'NFTAuction', primary: boolean, currency: AsaCode, price: number, duration: number, highestBid: number, started: boolean }> }, statistics: { __typename?: 'NFTStatistics', sold: boolean, latestSale?: { __typename?: 'NFTStatisticsSale', currency?: AsaCode | null, price?: number | null, usdValue?: number | null } | null } }>, pageInfo: { __typename?: 'PageInfo', totalDocs: number, offset: number, limit: number, totalPages: number, page: number, hasPrevPage: boolean, hasNextPage: boolean, prevPage?: number | null, nextPage?: number | null } } };
...
export type GetNfTsByCollectionQuery = { __typename?: 'Query', getNFTsByCollection: { __typename?: 'NFTsPaginated', nfts: Array<{ __typename?: 'NFT', id: any, info: { __typename?: 'NFTInfo', title: string, description: string, link: string, nsfw: boolean, ai: boolean, aiDescription: string, tags: Array<string>, updated: boolean }, token: { __typename?: 'NFTToken', index: number, unitName: string, assetName: string, royalty: number, editions: number, mintAddress: string, timestamp: any }, artist: { __typename?: 'NFTArtist', id: string, address: string, name: string, normalizedName: string, suspended: boolean, deleted: boolean, profileImage?: { __typename?: 'Media', cid: string, mimeType: string, previews: Array<{ __typename?: 'MediaPreview', size: number, cid: string, mimeType: string }> } | null }, card: { __typename?: 'NFTCard', x: number, y: number, type: Card_Type }, c?: { __typename?: 'NFTCollection', id: string, title: string, normalizedTitle: string, attributes: Array<{ __typename?: 'NFTCollectionAttribute', traitType: string, value: string, displayType: string }> } | null, media: { __typename?: 'NFTMedia', fileroomId?: string | null, cid: string, dimensions: string, storageSize: number, mimeType: string, integrity: string, previews: Array<{ __typename?: 'NFTMediaPreview', size: number, cid: string, mimeType: string, integrity?: string | null }>, thumbnail?: { __typename?: 'Media', cid: string, mimeType: string, previews: Array<{ __typename?: 'MediaPreview', size: number, cid: string, mimeType: string }> } | null }, metadata: { __typename?: 'NFTMetadata', id?: string | null, cid: string, mimeType: string, integrity: string, standard: string }, listings: { __typename?: 'NFTListings', listed: boolean, fixedBid: Array<{ __typename?: 'NFTFixedBid', primary: boolean, currency: AsaCode, price: number }>, auctions: Array<{ __typename?: 'NFTAuction', primary: boolean, currency: AsaCode, price: number, duration: number, highestBid: number, started: boolean }> }, statistics: { __typename?: 'NFTStatistics', sold: boolean, latestSale?: { __typename?: 'NFTStatisticsSale', currency?: AsaCode | null, price?: number | null, usdValue?: number | null } | null } }>, pageInfo: { __typename?: 'PageInfo', totalDocs: number, offset: number, limit: number, totalPages: number, page: number, hasPrevPage: boolean, hasNextPage: boolean, prevPage?: number | null, nextPage?: number | null } } };
...
export type GetNfTsByCollectorQuery = { __typename?: 'Query', getNFTsByCollector: { __typename?: 'NFTsPaginated', nfts: Array<{ __typename?: 'NFT', id: any, info: { __typename?: 'NFTInfo', title: string, description: string, link: string, nsfw: boolean, ai: boolean, aiDescription: string, tags: Array<string>, updated: boolean }, token: { __typename?: 'NFTToken', index: number, unitName: string, assetName: string, royalty: number, editions: number, mintAddress: string, timestamp: any }, artist: { __typename?: 'NFTArtist', id: string, address: string, name: string, normalizedName: string, suspended: boolean, deleted: boolean, profileImage?: { __typename?: 'Media', cid: string, mimeType: string, previews: Array<{ __typename?: 'MediaPreview', size: number, cid: string, mimeType: string }> } | null }, card: { __typename?: 'NFTCard', x: number, y: number, type: Card_Type }, c?: { __typename?: 'NFTCollection', id: string, title: string, normalizedTitle: string, attributes: Array<{ __typename?: 'NFTCollectionAttribute', traitType: string, value: string, displayType: string }> } | null, media: { __typename?: 'NFTMedia', fileroomId?: string | null, cid: string, dimensions: string, storageSize: number, mimeType: string, integrity: string, previews: Array<{ __typename?: 'NFTMediaPreview', size: number, cid: string, mimeType: string, integrity?: string | null }>, thumbnail?: { __typename?: 'Media', cid: string, mimeType: string, previews: Array<{ __typename?: 'MediaPreview', size: number, cid: string, mimeType: string }> } | null }, metadata: { __typename?: 'NFTMetadata', id?: string | null, cid: string, mimeType: string, integrity: string, standard: string }, listings: { __typename?: 'NFTListings', listed: boolean, fixedBid: Array<{ __typename?: 'NFTFixedBid', primary: boolean, currency: AsaCode, price: number }>, auctions: Array<{ __typename?: 'NFTAuction', primary: boolean, currency: AsaCode, price: number, duration: number, highestBid: number, started: boolean }> }, statistics: { __typename?: 'NFTStatistics', sold: boolean, latestSale?: { __typename?: 'NFTStatisticsSale', currency?: AsaCode | null, price?: number | null, usdValue?: number | null } | null } }>, pageInfo: { __typename?: 'PageInfo', totalDocs: number, offset: number, limit: number, totalPages: number, page: number, hasPrevPage: boolean, hasNextPage: boolean, prevPage?: number | null, nextPage?: number | null } } };
...
export type GetAllSalesQuery = { __typename?: 'Query', getAllSales: { __typename?: 'SalePaginated', sales: Array<{ __typename?: 'Sale', saleType: SaleType, nftIndex: number, appId: number, currency: AsaCode, unitPrice: number, nNFTs: number, totalPrice: number, txIDs: Array<string>, groupId?: string | null, sellerAddress: any, royaltyAddres: any, buyerAddress: any, sellerShare: number, royaltyShare: number, managerShare: number, round: number, timestamp: any, primary: boolean, totalValue: any, nft?: { __typename?: 'NFT', token: { __typename?: 'NFTToken', index: number }, info: { __typename?: 'NFTInfo', title: string, nsfw: boolean }, media: { __typename?: 'NFTMedia', fileroomId?: string | null, cid: string, dimensions: string, storageSize: number, mimeType: string, integrity: string, previews: Array<{ __typename?: 'NFTMediaPreview', size: number, cid: string, mimeType: string, integrity?: string | null }>, thumbnail?: { __typename?: 'Media', fileroomId?: string | null, cid: string, mimeType: string, previews: Array<{ __typename?: 'MediaPreview', size: number, cid: string, mimeType: string }> } | null } } | null }>, pageInfo: { __typename?: 'PageInfo', totalDocs: number, offset: number, limit: number, totalPages: number, page: number, hasPrevPage: boolean, hasNextPage: boolean, prevPage?: number | null, nextPage?: number | null } } };
...
export type GetDestroyV1ListingParamsQuery = { __typename?: 'Query', getDestroyV1ListingParams: Array<Array<{ __typename?: 'UsignedTxn', description: string, txID: string, signers: Array<any>, signature: string, authAddress: any, blob: any }>> };
...
export type VerifyTxnQuery = { __typename?: 'Query', verifyTxn: Array<Array<{ __typename?: 'UsignedTxn', description: string, txID: string, blob: any, signers: Array<any>, signature: string, authAddress: any }>> };
...
export type NewApplicationsSubscription = { __typename?: 'Subscription', newApplications: { __typename?: 'ApplicationDetails', id: any, name: string, email: any, status: ApplicationStatuses, twitter?: string | null, instagram?: string | null, links?: string | null, art?: Array<string> | null } };

export type NewBandsSubscriptionVariables = Exact<{ [key: string]: never; }>;


export type NewBandsSubscription = { __typename?: 'Subscription', newBands: { __typename?: 'BandDetails', id: any, name: string, status: BandStatuses } };

export type SubAllNewSalesSubscriptionVariables = Exact<{ [key: string]: never; }>;


export type SubAllNewSalesSubscription = { __typename?: 'Subscription', subAllNewSales: { __typename?: 'Sale', saleType: SaleType, nftIndex: number, appId: number, currency: AsaCode, unitPrice: number, nNFTs: number, totalPrice: number, totalValue: any, txIDs: Array<string>, groupId?: string | null, sellerAddress: any, royaltyAddres: any, buyerAddress: any, sellerShare: number, royaltyShare: number, managerShare: number, round: number, timestamp: any, primary: boolean, nft?: { __typename?: 'NFT', token: { __typename?: 'NFTToken', index: number }, info: { __typename?: 'NFTInfo', title: string, nsfw: boolean }, media: { __typename?: 'NFTMedia', fileroomId?: string | null, cid: string, dimensions: string, storageSize: number, mimeType: string, integrity: string, previews: Array<{ __typename?: 'NFTMediaPreview', size: number, cid: string, mimeType: string, integrity?: string | null }>, thumbnail?: { __typename?: 'Media', fileroomId?: string | null, cid: string, mimeType: string, previews: Array<{ __typename?: 'MediaPreview', size: number, cid: string, mimeType: string }> } | null } } | null } };
