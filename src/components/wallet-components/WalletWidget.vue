...
import { ArrowRightEndOnRectangleIcon, ArrowDownIcon } from "@heroicons/vue/24/solid";
...
<template>
  <div class="dropdown-container">
    ...
    <ul class="dropdown-items" v-if="dropDownOpen">
      <li class="dropdown-option" @click="connectedWalletProvider?.disconnect">
        <p>Disconnect</p>
        <ArrowRightEndOnRectangleIcon class="disconnect-icon" />
      </li>
      <NuxtLink class="dropdown-option" :to="`/user/${user.address}`">
